...
void MultiWriteSimulateTest(uint64_t cycles) {
	...
	char* configtable_data = "0123456";
	char* flowrate_data    = "11.22";
	char* waterlevel_data  = "989.23";
...
// 423, 213, 		322, 753, 433, 442, 657, 413, 401, 546, 219, 321, 411, 434, 442, 446, 344, 91,	307, 434, 194,
